...
URIFixup.prototype = {
  ...
  getFixupURIInfo(uriString, fixupFlags = FIXUP_FLAG_NONE, postData) {
    ...
    if (
      ...
      tryKeywordFixupForURIInfo(uriString, info, postData);
    }
    ...
    if (
      ...
      keywordURIFixup(uriString, info, postData);
      if (info.preferredURI) {
        return info;
      }
    }
...
function keywordURIFixup(uriString, fixupInfo, postData) {
