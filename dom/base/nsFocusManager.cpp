...
#include "mozilla/dom/UserActivation.h" //MY
...
void nsFocusManager::SetFocusInner(Element* aNewContent, int32_t aFlags,
  ...
  if (sendFocusEvent) {
    ...
    Focus(newWindow, elementToFocus, aFlags, !isElementInFocusedWindow,
          aFocusChanged, false, aAdjustWidget, blurredInfo);
  } else {
...
void nsFocusManager::Focus(
    ...
    bool aAdjustWidget, const Maybe<BlurredElementInfo>& aBlurredElementInfo) {
